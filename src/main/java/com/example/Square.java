...
public class Square extends JComponent {
    ...
    private SpecialKnight occupyingPiece;
    ...
    public SpecialKnight getOccupyingPiece() {
    ...
    public void put(SpecialKnight p) {
        this.occupyingPiece = p;
    }
    
    //precondition: none
    //postcondition: returns the piece in this Square. Returns null if the square is empty.
    public SpecialKnight removePiece() {
        SpecialKnight p = this.occupyingPiece;
